 ...
 *
 * Bruker android.R.layout.simple_list_item_2 (innebygd Android-layout)
 * slik at ingen egne res-filer trengs og R.layout/R.id aldri feiler.
 */
public class KtWidget extends AppWidgetProvider {
    ...
    static void updateWidget(Context ctx, AppWidgetManager mgr, int id) {
        ...
        // Bruker innebygd Android two-line layout – ingen egne res-filer
        ...
        views.setTextColor(android.R.id.text2, color2);
